...
It follows the [WAI specifications](//www.w3.org/WAI/tutorials/forms/) for
forms.
...
Form Libraries like [Formik](//jaredpalmer.com/formik/) make it soooo easy to
manage form state and validation. I 💖 Formik
